(** Combines Known bit analysis and wrapped interval analysis to get more presice values. *)
...
module ReducedProductLattice = struct
  let name = "reducedProduct"
...
let wint_to_tnum wint =
  ...
  module Reduced_productValueAbstractionBasil = struct
  include ReducedProductLattice
